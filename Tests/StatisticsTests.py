...
class MyTestCase(unittest.TestCase):
    ...
    def test_population_mean(self, test_data):
    ...
    def test_mode(self, test_data):
        for row in test_data:
            result = float(row['Mode'])
            self.assertEqual(self.statistics.mode(row['Values'], result))
            self.assertEqual(self.statistics.result, result)

    def test_population_standard_deviance(self, test_data):
        for row in test_data:
    ...
    def test_variance_population_proportion(self, test_data):
        for row in test_data:
